...
export function useGetByBankAccountItem(params: { id: number | false, method: Enum.Method | null, accountedType: AccountedType }) {
	return useQuery(["accounted", "bank-account", params.id, params.method], async () => {
		if (params.id === false) {
			return null;
		}
...
export function useByBankAccountCreate() {
	...
	return useMutation(
		async (params: { data: Api.ByBankAccountCreateRequest }) => {
...
export function useByBankAccountUpdate() {
	...
	return useMutation(
		async (params: { data: Api.ByBankAccountUpdateRequest; id: number }) => {
...
export function useByBankAccountDelete() {
	...
	return useMutation(
		async (params: { id: number | false, accountedType: AccountedType }) => {
			const resp = await axios.delete(`${API_HOST}/accounted/accountedType/${params.accountedType}/accountedId/${params.id}/bank-account`);
			return resp.data;
		},
		{
			onSuccess: async () => {
